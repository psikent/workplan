...
- **Accent**: cyan `#0891b2` in light theme and `#22d3ee` in dark theme; static install icons use the stable light-theme brand color `#0891b2`. Green, amber, coral, and slate are reserved for status and priority.
