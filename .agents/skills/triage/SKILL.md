...
These are canonical role names — the actual label strings used in the issue tracker may differ. The mapping should have been provided to you - see `docs/agents/issue-tracker.md` and `docs/agents/triage-labels.md` in this repo if not.
