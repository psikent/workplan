...
> Status: **待审批** — grilling 2026-09-09;第一轮 4 项用户已确认(D1、D2、D3 核心「条段居中」、D4 核心「始终显示+省略号」);第二轮 3 项用户未作答,按推荐答案代理采用(D3「统一适用于所有被跨及视图」、D4「画布判定」、D5 术语),审批时可整体否决;票据 01–03 已建(01 → 02 → 03)。
