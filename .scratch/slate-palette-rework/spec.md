...
| Q3 | 暗色强调色 | ~~冷蓝 indigo-400 #818cf8~~ → **青色 cyan**（2026-09-05 实机后用户否决靛蓝：不在参考配色内且与整体不符；改为参考页前端色 暗色 #22d3ee / 浅色 #0891b2） |
| Q4 | 语义色 | 采用参考页色相（琥珀/翠绿/蓝灰/玫红），徽章 + Gantt 同步 |
| Q5 | 工程深度 | 换色与「收敛 CSS 变量」一起做 |
| Q6 | 浅色中性底盘 | 参考页浅色 Slate |
| Q7 | 浅色强调色 | ~~冷蓝 indigo-500 #6366f1~~ → **青色 cyan**（随 Q3 调整） |
| Q8 | 浅色语义色 | 参考页浅色语义色 |
...
| 强调色 --accent | `#22d3ee` | cyan-400；hover `#67e8f9`（cyan-300）；软底同色 α≈14% |
...
Gantt 暗色条：进行中 `#34d399`/`#059669`，待开始 `#fbbf24`/`#d97706`，已完成 `#64748b`/`#475569`，已取消 `#475569`/`#334155`，默认条 `#22d3ee`/`#0891b2`；「今天」高亮沿用 --accent；亮青药丸上日期与提醒铃铛统一深藏青（琥珀在青底撞色，2026-09-06 用户定稿）。
...
| 强调色 --accent | `#0891b2` | cyan-600；hover `#0e7490`（cyan-700）；软底同色 α≈10% |
...
Gantt 浅色条：进行中 `#10b981`/`#059669`，待开始 `#f59e0b`/`#d97706`，已完成 `#94a3b8`/`#64748b`，已取消 `#cbd5e1`/`#94a3b8`，默认条 `#67e8f9`/`#22d3ee`。
